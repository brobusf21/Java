...
public class HTMLLinkParser {
        ...
        //"(?i)<\\s*a+\\s*([^>]+)href\\s*=\\s*\"([^\"]+)\"";
        //(case insensitive) (\\s* equals white spaces) (\ for special char.) (Then create group using parentheses)
        //([^\">] means it can not have double quotes ([^>]*>) means anything but
